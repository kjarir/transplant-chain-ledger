...
export class DatabaseInitializer {
  static async initializeDatabase(): Promise<boolean> {
    try {
      console.log('Initializing live organ tracking database...');
      ...
      // Insert medical centers (ignore if they already exist)
      ...
      console.log('✅ Medical centers initialized successfully');
      return true;
  ...
  static async addSampleOrgans(): Promise<boolean> {
    try {
      const sampleOrgans = [
        {
          organ_type: 'heart',
      ...
      console.log('✅ Sample organs added successfully');
      return true;

    } catch (error) {
      console.error('Error adding sample organs:', error);
      return false;
    }
  }
}
